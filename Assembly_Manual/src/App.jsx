...
export default function App() {
    ...
    const modelIn = useGLTF('./OLSK_Vinyl_Cutter_V3_IN.glb') //Substitute the file name here for ALL IN
    const modelOut = useGLTF('./OLSK_Vinyl_Cutter_V3_OUT.glb') //Substitute the file name here for ALL OUT
    ...
    useGLTF.clear('./OLSK_Vinyl_Cutter_V3_IN.glb')  //Substitute the file name here for ALL IN
    useGLTF.clear('./OLSK_Vinyl_Cutter_V3_OUT.glb') //Substitute the file name here for ALL OUT
...
useGLTF.preload('./OLSK_Vinyl_Cutter_V3_IN.glb') //Substitute the file name here for ALL IN
useGLTF.preload('./OLSK_Vinyl_Cutter_V3_OUT.glb') //Substitute the file name here for ALL OUT
